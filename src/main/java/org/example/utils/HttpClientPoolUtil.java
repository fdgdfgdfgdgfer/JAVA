...
public class HttpClientPoolUtil {
     ...
     * 默认请求超时时间30s
     */
    private static final int DEFAUL_TTIME_OUT = Integer.parseInt("30");

    private static final int count = Integer.parseInt("300");

    private static final int totalCount = Integer.parseInt("300");

    private static final int Http_Default_Keep_Time = Integer.parseInt("60");
